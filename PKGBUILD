...
options=('!strip')
source=("https://github.com/chlorisdroid/linux-rt-odroid-c1/archive/${_commit}.tar.gz"
...
_package() {
  ...
  conflicts=('linux' 'linux-odroid-c1')
  ...
  ln -s "../extramodules-${_basekernel}-${_kernelname:-rt88}" "${pkgdir}/lib/modules/${_kernver}/extramodules"
  # add real version for building modules and running depmod from post_install/upgrade
  mkdir -p "${pkgdir}/lib/modules/extramodules-${_basekernel}-${_kernelname:-rt88}"
  echo "${_kernver}" > "${pkgdir}/lib/modules/extramodules-${_basekernel}-${_kernelname:-rt88}/version"
